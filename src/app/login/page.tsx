...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="card w-full max-w-sm p-7" data-allow-enter>
        <div className="text-center mb-6">
          <div className="text-xl font-bold text-accent-600">VHJSC</div>
        ...
        <input
          ...
          onKeyDown={(e) => {
            // Cổng đăng nhập rủi ro thấp: cho Enter để đăng nhập.
