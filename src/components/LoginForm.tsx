...
const LOI: Record<string, string> = {
  ...
  oauth: 'Đăng nhập chưa thành công, vui lòng thử lại.',
}
...
export default function LoginForm({ logoUrl, brandText }: { logoUrl: string | null; brandText: string }) {
  ...
  function googleLogin() {
    ...
    // Chuyển sang route của app để tự dựng URL consent (redirect_uri = tên miền app).
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="card w-full max-w-sm p-7">
        ...
        >
          ...
          {gLoading ? 'Đang chuyển…' : 'Đăng nhập bằng email'}
        </button>
