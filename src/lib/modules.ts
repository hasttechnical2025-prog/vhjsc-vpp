...
export const MODULES: AppModule[] = [
  {
    ...
    home: '/phieu',
    prefixes: ['/tong-quan', '/dang-ky', '/phieu', '/thong-ke', '/admin/san-pham', '/admin/cap-nhat-gia'],
    nav: [
      { href: '/tong-quan', label: 'Tổng quan', roles: ['admin', 'hcns'] },
      { href: '/dang-ky', label: 'Lập phiếu' },
      { href: '/phieu', label: 'Danh sách phiếu' },
      { href: '/thong-ke', label: 'Thống kê', roles: ['admin', 'hcns'] },
      { href: '/admin/san-pham', label: 'Sửa mặt hàng', roles: ['admin'] },
      { href: '/admin/cap-nhat-gia', label: 'Cập nhật giá', roles: ['admin'] },
    ],
  },
  {
    key: 'ncc',
  ...
  },
  {
    ...
    icon: '⚙️',
    mo_ta: 'Người dùng, phòng ban và cấu hình thương hiệu.',
    home: '/admin',
    prefixes: ['/admin/nguoi-dung', '/admin/cau-hinh', '/admin'],
    roles: ['admin', 'hcns'],
    nav: [
      { href: '/admin', label: 'Tổng quan' },
      { href: '/admin/nguoi-dung', label: 'Người dùng & Phòng ban', roles: ['admin'] },
      { href: '/admin/cau-hinh', label: 'Cấu hình hiển thị', roles: ['admin'] },
    ],
  },
]
